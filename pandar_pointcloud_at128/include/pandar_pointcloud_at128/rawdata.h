...
#ifndef __PANDAR_RAWDATA_AT128_H
#define __PANDAR_RAWDATA_AT128_H
...
namespace pandar_rawdata_at128
{
...
private:
     ...
     * Calibration file
     */
    pandar_pointcloud_at128::Calibration calibration_;
	...
	void computeXYZIR(PPoint& point, int azimuth,
			...
			const pandar_pointcloud_at128::PandarLaserCorrection& correction);
...
#endif // __PANDAR_RAWDATA_AT128_H
