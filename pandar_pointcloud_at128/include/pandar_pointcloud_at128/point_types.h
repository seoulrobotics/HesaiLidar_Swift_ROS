...
#ifndef __PANDAR_POINTCLOUD_AT128_POINT_TYPES_H
#define __PANDAR_POINTCLOUD_AT128_POINT_TYPES_H
...
POINT_CLOUD_REGISTER_POINT_STRUCT(pandar_pointcloud_at128::PointXYZIR,
                                  (float, x, x)
                                  (float, y, y)
                                  (float, z, z)
...
POINT_CLOUD_REGISTER_POINT_STRUCT(pandar_pointcloud_at128::PointXYZIT,
                                  (float, x, x)(float, y, y)(float, z, z)
                                  (uint8_t, intensity, intensity)(double, timestamp, timestamp)(uint16_t, ring, ring))

POINT_CLOUD_REGISTER_POINT_STRUCT(pandar_pointcloud_at128::PointXYZITd,
                                  (double, x, x)(double, y, y)(double, z, z)(uint8_t, intensity, intensity)(double, timestamp,
                                          timestamp))

POINT_CLOUD_REGISTER_POINT_STRUCT(pandar_pointcloud_at128::PointXYZd,
                                  (double, x, x)(double, y, y)(double, z, z))
POINT_CLOUD_REGISTER_POINT_STRUCT(pandar_pointcloud_at128::PointXYZRGBd,
                                  (double, x, x)(double, y, y)(double, z, z)(float, rgb, rgb))
#endif // __PANDAR_POINTCLOUD_AT128_POINT_TYPES_H
