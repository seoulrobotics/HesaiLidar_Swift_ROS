...
int RawData::setup(ros::NodeHandle private_nh)
{
    ...
    if (!private_nh.getParam("calibration", config_.calibrationFile))
    {
        ...
        std::string pkgPath = ros::package::getPath("pandar_pointcloud_at128");
...
void RawData::computeXYZIR(PPoint& point, int azimuth,
		const raw_measure_t& laserReturn, const pandar_pointcloud_at128::PandarLaserCorrection& correction)
{
