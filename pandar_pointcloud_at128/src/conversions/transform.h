...
#ifndef _PANDAR_POINTCLOUD_AT128_TRANSFORM_H_
#define _PANDAR_POINTCLOUD_AT128_TRANSFORM_H_ 1
...
#include <pandar_pointcloud_at128/point_types.h>

#include <dynamic_reconfigure/server.h>
#include <pandar_pointcloud_at128/TransformNodeConfig.h>

// include template implementations to transform a custom point cloud
#include <pcl_ros/impl/transforms.hpp>
#include "convert.h"
#include <pandar_pointcloud_at128/input.h>
#include <queue>

/** types of point and cloud to work with */
typedef pandar_rawdata_at128::PPoint PPoint;
typedef pandar_rawdata_at128::PPointCloud PPointCloud;
...
namespace pandar_pointcloud_at128
{
  ...
  private:
    ...
    boost::shared_ptr<dynamic_reconfigure::Server<pandar_pointcloud_at128::
      TransformNodeConfig> > srv_;
    void reconfigure_callback(pandar_pointcloud_at128::TransformNodeConfig &config,
                  uint32_t level);
...
#endif // _PANDAR_POINTCLOUD_AT128_TRANSFORM_H_
