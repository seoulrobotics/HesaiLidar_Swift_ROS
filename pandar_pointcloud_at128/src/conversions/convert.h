...
#ifndef _PANDAR_POINTCLOUD_AT128_CONVERT_H_
#define _PANDAR_POINTCLOUD_AT128_CONVERT_H_ 1

#include <pandar_pointcloud_at128/rawdata.h>
#include <pthread.h>
#include <ros/ros.h>
#include <semaphore.h>
...
#include <pandar_pointcloud_at128/CloudNodeConfig.h>
#include <pandar_pointcloud_at128/calibration.h>
...
#include <vector>
#include <pandar_pointcloud_at128/fault_message.h>
...
typedef pandar_pointcloud_at128::PointXYZIT PPoint;
...
class Convert {
 ...
 private:
  void callback(pandar_pointcloud_at128::CloudNodeConfig &config, uint32_t level);
  ...
  boost::shared_ptr<
      dynamic_reconfigure::Server<pandar_pointcloud_at128::CloudNodeConfig> >
      srv_;

  boost::shared_ptr<pandar_rawdata_at128::RawData> data_;
  ...
  time_t gps1;
  pandar_rawdata_at128::gps_struct_t gps2;
  bool hasGps;

  unsigned int lastGPSSecond;
  int m_iLidarRotationStartAngle;

  pandar_pointcloud_at128::PandarDriver drv;
...
#endif  // _PANDAR_POINTCLOUD_AT128_CONVERT_H_
