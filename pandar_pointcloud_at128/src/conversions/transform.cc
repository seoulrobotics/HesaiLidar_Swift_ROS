...
namespace pandar_pointcloud_at128
{
  ...
  {
    m_input.reset(new pandar_pointcloud_at128::InputSocket(private_nh, "", 2368));
    ...
    srv_ = boost::make_shared <dynamic_reconfigure::Server<pandar_pointcloud_at128::
      TransformNodeConfig> > (private_nh);
    dynamic_reconfigure::Server<pandar_pointcloud_at128::TransformNodeConfig>::
      CallbackType f;
  ...
  void Transform::reconfigure_callback(
      pandar_pointcloud_at128::TransformNodeConfig &config, uint32_t level)
  {
